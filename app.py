...
for linha in pagina_fornecedores.iter_rows(min_row=2,values_only=True):
    ...
    arquivo_word.add_heading('Contrato de Prestação de Serviços')
    texto_contrato = f"""    Este contrato de prestação de serviços é feito entre {nome_empresa}, com endereço em {endereco}, 
    ...
    CONTRATANTE: Samuel Sander
    E-mail: samuelsander@samuelsander
